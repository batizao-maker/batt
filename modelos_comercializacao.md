...
2. Diagnóstico (call de 30–45 min)
3. Demo orientada a resultados
4. Proposta e fechamento
5. Onboarding em até 14 dias
...
## 2) Modelo de comercialização de serviços recorrentes (retainer)
...
- Retainer + variável (performance): 
- Bônus por meta atingida: 

**Onboarding**
- Kickoff com objetivos e KPIs
- Checklist de acesso
- Plano de 30/60/90 dias

**Renovação e expansão**
- Revisão trimestral de resultados
- Pacotes adicionais

---

## 3) Modelo de comercialização por projeto (escopo fechado)
...
## 4) Modelo de comercialização por licenciamento

**Produto/licença**
- Tipo (por usuário, por instância, por volume): 
- Limites de uso: 
...
## 5) Modelo de comercialização por parceria (revenda ou co-sell)
...
**Habilitação do parceiro**
- Materiais de venda
- Treinamento e certificação

---

## 6) Modelo de comercialização freemium com upgrade
...
## Checklists finais (use para validação)

**Checklist de proposta**
- [ ] Dor e resultado claros
- [ ] Evidências/estudos de caso
- [ ] Objeções respondidas
- [ ] Próximo passo definido

**Checklist de operação comercial**
- [ ] CRM configurado
- [ ] Pipeline definido
